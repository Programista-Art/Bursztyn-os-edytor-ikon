...
/* =========================================================================
 * 5.1 FORMAT IKON - dane zamiast setek wywolan ( .data, nie .text )
 * ========================================================================= */

struct FragmentIkonyPulpitu {
    uint8_t x;
    uint8_t y;
    uint8_t szer;
    uint8_t wys;
    uint8_t kolor; // indeks w palecie
};

/*
 * Rysuje ikone zdefiniowana przez palete i fragmenty.
 * Wspolrzedne fragmentow sa wzgledne wewnatrz ikony (0..szer-1).
 */
